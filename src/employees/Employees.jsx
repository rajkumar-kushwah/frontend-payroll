...
import { FaUsers, FaCheckCircle, FaTimesCircle, FaSearch, FaFilter, FaPlus } from "react-icons/fa";
      ...
      <div className="overflow-x-auto max-h-[60vh] bg-white rounded shadow text-xs">
        <table className="w-full border-collapse">
          <thead className="bg-gray-100 sticky top-0">
            <tr>
              {["ID", "Name", "Email", "Phone", "Role", "Dept", "Status", "Join", "Actions"].map(h => (
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan="9" className="text-center p-2">No Employees</td></tr>
            )}
          </tbody>
        </table>
      </div>
